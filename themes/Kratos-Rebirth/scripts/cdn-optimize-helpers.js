...
hexo.once("generateBefore", () => {
  ...
  hexo.extend.helper.register(
    "file_info_theme_cdn",
    cdn.file_info_theme_cdn.bind(null, hexo),
  );
  hexo.extend.helper.register(
    "url_theme_cdn",
    cdn.url_theme_cdn.bind(null, hexo),
  );
  hexo.extend.helper.register(
    "js_theme_cdn",
    cdn.js_theme_cdn.bind(null, hexo),
  );
  hexo.extend.helper.register(
    "css_theme_cdn",
  ...
  hexo.extend.helper.register(
    "file_info_npm_cdn",
    cdn.file_info_npm_cdn.bind(null, hexo),
  );
  ...
  hexo.extend.helper.register("css_npm_cdn_async", cdn.css_npm_cdn_async.bind(null, hexo));
});
